...
class LastPossibleNumberDescription extends StatefulWidget {
  const LastPossibleNumberDescription({super.key});
  static const String assetFolderPath = "lib/assets/techniques/last_possible_number/";

  @override
  State<LastPossibleNumberDescription> createState() => _LastPossibleNumberDescriptionState();
}

class _LastPossibleNumberDescriptionState extends State<LastPossibleNumberDescription> {
  final Future<double> img1Future = TechniquePage.getImageHeightAsync(Image.asset("${LastPossibleNumberDescription.assetFolderPath}last_possible_number.png"));
