		...
		for (var i = 0; i < 9; i++) {
          ...
          for (var pc in peerCells) {
            pc.candidates.remove(solution);
				...
				return TechniqueResult(applicableCells: [SudokuCell(i, colNo, true, solution)], usedTechnique: SudokuRulesTechnique);
			}
			// check columns
          ...
          for (var pc in peerCells) {
            pc.candidates.remove(solution);
				...
				return TechniqueResult(applicableCells: [SudokuCell(rowNo, i, true, solution)], usedTechnique: SudokuRulesTechnique);
			}
		}
		// check blocks
		for (var i = 0; i < 9; i += 3) {
            ...
            for (var pc in peerCells) {
              pc.candidates.remove(solution);
					...
					return TechniqueResult(applicableCells: [SudokuCell(cell.row, cell.col, true, solution)], usedTechnique: SudokuRulesTechnique);
				}
			}
		}
		return null;
